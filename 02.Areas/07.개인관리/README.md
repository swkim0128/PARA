...
6. 🚫 **주기 페이지 생성 금지 (2026-08-22)** — 다이어리·식단 페이지 생성은 **매주 일요일 n8n 자동화 소관**이다. 에이전트는 어떤 경로로도 이 페이지들을 직접 생성하지 않는다. 대상 페이지가 없으면 **생성하지 말고 그 사실을 보고**하고 중단한다. (근거: 2026-08-22 week 34 일지가 자동 생성분 + 스킬 생성분으로 2개가 되어 화·수·목 기록이 갈라졌다. week 30 도 동일 사고.)
