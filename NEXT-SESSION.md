...
- 🔴 **미푸시 (2026-09-23)**: 커밋 4건이 전부 로컬에만 있다 — `para` `1076565` · `vibe-ai-config` `b21cfe0`·`9d1648b` · `vibe-dotfiles` `4ab0a0d`. **다른 머신은 pull 전까지 구 상태**이고, 특히 dotfiles 심링크가 구 경로를 가리켜 `vibe` 계열이 깨진다. 푸시는 사용자 승인 대기 중.
