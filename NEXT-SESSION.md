...
- ⚠️ **Budge 페이지가 구 지출 DB 3종(`7129a14e`·`2ad01c66`·`280a2519`)을 물고 있음** — 확정한 예산 3-DB(🏦 HL `e1da27ac` / 💳 거래내역 `c700b755` / 🧺 Ledger)와 불일치. 정합 작업 필요.
...
- **다음 행동: `Pulse` 탭에 차트 3종(프로젝트 상태 도넛·Task 상태 도넛·월별 지출 추이 막대) + 숫자 카드 3개 생성** → 그다음 `Week` 탭(링크드 뷰) 구성 여부 결정(홈에서 DB 뷰를 보는 것까지 허용되는지 사용자 확인 필요).
